...
speed_data = pd.read_excel('/Users/student/Desktop/Battery simulation/Cell and module data.xlsx', sheet_name='drive cycle')
...
car_data = pd.read_excel('/Users/student/Desktop/Battery simulation/Cell and module data.xlsx', sheet_name='car data')
...
# rolling resistance coefficient #Need to work out
roll_res_co = car_data.iloc[2, 1]
car_mass = car_data.iloc[3, 1]  # Need to check correct value
